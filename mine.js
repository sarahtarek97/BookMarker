...
function createWell(bookmark) {
    ...
    var link = `<a class="btn btn-primary m-2" href= "${bookmark.url}" target="_blank">visit</a>` //setting the link
    var btndelete = `<button class="btn btn-danger btndelete m-2">Delete</button>`; //setting the delete button
